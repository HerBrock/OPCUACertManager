...
v0.1.0 enhancement: After creating a project, immediately shows CA creation dialog.
"""
...
class CreateCADialog:
    """
    Modal dialog to create a Certificate Authority immediately after project creation.
    
    v0.1.0: This dialog is shown right after creating a new project.
    The CA is immutable once created for that project.
    """
    
    def __init__(self, parent: tk.Tk, project_path: Path) -> None:
        """
        Create and display the CA creation dialog.
    ...
    def _build_ui(self) -> None:
        ...
        title_label = ttk.Label(
            main_frame,
            text="Configure Certificate Authority (CA)",
        ...
        subtitle_label = ttk.Label(
            main_frame,
            text="Fields marked with * are required. The CA cannot be changed later.",
            font=("Segoe UI", 9),
            foreground="gray",
        )
        ...
        # Common Name (CN)*
        ttk.Label(form_frame, text="Common Name (CN) *").grid(
            row=0, column=0, sticky="w", padx=5, pady=5
        )
        self.cn_entry = ttk.Entry(form_frame, width=50)
        self.cn_entry.grid(row=0, column=1, sticky="ew", padx=5, pady=5)
        
        # Organization*
        ttk.Label(form_frame, text="Organization *").grid(
            row=1, column=0, sticky="w", padx=5, pady=5
        )
        self.org_entry = ttk.Entry(form_frame, width=50)
        self.org_entry.insert(0, "MiEmpresa")
        self.org_entry.grid(row=1, column=1, sticky="ew", padx=5, pady=5)
        
        # Country*
        ttk.Label(form_frame, text="Country *").grid(
            row=2, column=0, sticky="w", padx=5, pady=5
        )
        self.country_entry = ttk.Entry(form_frame, width=50)
        self.country_entry.insert(0, "ES")
        self.country_entry.grid(row=2, column=1, sticky="ew", padx=5, pady=5)
        ...
        self.state_entry.insert(0, "Madrid")
        self.state_entry.grid(row=3, column=1, sticky="ew", padx=5, pady=5)
        
        # Locality (optional)
        ttk.Label(form_frame, text="Locality").grid(
            row=4, column=0, sticky="w", padx=5, pady=5
        )
        self.locality_entry = ttk.Entry(form_frame, width=50)
        self.locality_entry.insert(0, "Madrid")
        self.locality_entry.grid(row=4, column=1, sticky="ew", padx=5, pady=5)
        
        # Validity (days)
        ttk.Label(form_frame, text="Validity (days)").grid(
            row=5, column=0, sticky="w", padx=5, pady=5
        )
        self.validity_entry = ttk.Entry(form_frame, width=50)
        self.validity_entry.insert(0, "3650")
        self.validity_entry.grid(row=5, column=1, sticky="ew", padx=5, pady=5)
        
        # Key Size
        ttk.Label(form_frame, text="Key Size").grid(
        ...
        key_combo.grid(row=6, column=1, sticky="w", padx=5, pady=5)
    ...
    def _create_ca(self) -> None:
        ...
        try:
            ...
            messagebox.showerror(
                "Invalid Validity",
                "Validity must be a positive integer.",
                parent=self.top,
            )
            return
        ...
        result = create_ca(
            ...
            locality_name=locality or "Unknown",
    ...
    def _cancel(self) -> None:
        """Close dialog without creating CA."""
        self.ca_created = False
